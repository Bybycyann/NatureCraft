...
# 根据标签匹配情况生成状态编码
function naturecraft:place/init/states/pizzle/code with storage naturecraft:main states.list[0].condition
#        tellraw @a ["[Debug] ",{storage:"naturecraft:main",nbt:"states.code"}]

# 匹配
function naturecraft:place/init/states/pizzle/comp
